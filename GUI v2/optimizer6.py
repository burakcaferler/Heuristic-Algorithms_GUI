...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget.setGeometry(QtCore.QRect(110, 320, 631, 361))
    ...
    def fuction_select(self):
        ...
        if func==0:
            ...
            return functions.selectFunctFion(Functions.dixonprice)
...
if __name__ == "__main__":
    ...
    widget.layout().addWidget(graph_widget)
