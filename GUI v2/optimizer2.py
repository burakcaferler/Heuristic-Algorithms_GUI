...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.func_comboBox.currentIndexChanged.connect(self.select_function)
    ...
    def select_function(self,index):
        obj_functions=Functions.selectFunction(self.func_comboBox.currentIndex()) 
    def select_algorithm(self,index):
        algorithm=algorithms.selectAlgorithm(self.algorithm_comboBox.currentIndex())
