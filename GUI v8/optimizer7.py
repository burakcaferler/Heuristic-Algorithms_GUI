...
bounds=[[-32.768,32.768],[-10,10],[-600,600],[0,pi],[-30.30],[-4,5],[0,4],[-5.12,5.12],[-2.048,2.048],[-500,500],[-5.12,5.12],[-10,10],[-900,900],[-5,10],[-65.536, 65.536],[0,0.1],[0,0.1],[-10,10],[0,0.1],[1,1]]
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def function_select(self):
            ...
            if func==0:
                ...
                return functions.selectFunction(Functions.custom)
            elif func == 19: 
